...
class UNet2DConditionModel(ModelMixin, ConfigMixin, UNet2DConditionLoadersMixin):
    ...
    def forward(
        ...
        if is_controlnet:
            # print(f"sample:{sample.shape},down_block_res_samples:{down_block_res_sample[0].shape} ,mid_block: {mid_block_additional_residual.shape}")
            sample = sample + mid_block_additional_residual

        # 5. up
        up_ft = {}
        up_ft_indices = [1] # extract unet layers
