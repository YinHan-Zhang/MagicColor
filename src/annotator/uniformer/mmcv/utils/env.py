...
def collect_env():
    ...
    if cuda_available:
        ...
        from src.annotator.uniformer.mmcv.utils.parrots_wrapper import _get_cuda_home
    ...
    try:
        from src.annotator.uniformer.mmcv.ops import get_compiler_version, get_compiling_cuda_version
    except ModuleNotFoundError:
