...
from src.annotator.oneformer.detectron2.utils.registry import _convert_target_to_string
...
class LazyCall:
    ...
    Examples:
    ::
        from src.annotator.oneformer.detectron2.config import instantiate, LazyCall
