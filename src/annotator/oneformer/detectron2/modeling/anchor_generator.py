...
from src.annotator.oneformer.detectron2.layers import ShapeSpec, move_device_like
from src.annotator.oneformer.detectron2.structures import Boxes, RotatedBoxes
