...
from src.annotator.oneformer.detectron2.utils.env import _import_file
...
def patch_nonscriptable_classes():
    ...
    from src.annotator.oneformer.detectron2.modeling.backbone import ResNet, FPN
    ...
    from src.annotator.oneformer.detectron2.modeling.roi_heads import StandardROIHeads
