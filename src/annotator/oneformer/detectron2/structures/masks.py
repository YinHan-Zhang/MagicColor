...
from src.annotator.oneformer.detectron2.layers.roi_align import ROIAlign
...
class ROIMasks:
    ...
    def to_bitmasks(self, boxes: torch.Tensor, height, width, threshold=0.5):
        ...
        """
        from src.annotator.oneformer.detectron2.layers.mask_ops import paste_masks_in_image, _paste_masks_tensor_shape
