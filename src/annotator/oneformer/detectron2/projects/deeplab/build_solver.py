...
from src.annotator.oneformer.detectron2.solver import LRScheduler
from src.annotator.oneformer.detectron2.solver import build_lr_scheduler as build_d2_lr_scheduler
