...
from src.annotator.oneformer.detectron2.layers import CNNBlockBase, Conv2d, get_norm
from src.annotator.oneformer.detectron2.modeling import BACKBONE_REGISTRY
from src.annotator.oneformer.detectron2.modeling.backbone.resnet import (
    BasicStem,
    BottleneckBlock,
