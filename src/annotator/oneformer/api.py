...
from src.annotator.oneformer.detectron2.config import get_cfg
from src.annotator.oneformer.detectron2.projects.deeplab import add_deeplab_config
from src.annotator.oneformer.detectron2.data import MetadataCatalog

from src.annotator.oneformer.oneformer import (
...
from src.annotator.oneformer.oneformer.demo.defaults import DefaultPredictor
from src.annotator.oneformer.oneformer.demo.visualizer import Visualizer, ColorMode
