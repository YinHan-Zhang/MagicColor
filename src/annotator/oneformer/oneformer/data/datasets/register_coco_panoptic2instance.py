...
import os
from src.annotator.oneformer.detectron2.data.datasets.builtin_meta import  _get_builtin_metadata
from src.annotator.oneformer.detectron2.data.datasets.coco import register_coco_instances
