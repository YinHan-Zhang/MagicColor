...
from src.annotator.oneformer.detectron2.data import DatasetCatalog, MetadataCatalog
from src.annotator.oneformer.detectron2.data.datasets import load_sem_seg
from src.annotator.oneformer.detectron2.data.datasets.builtin_meta import COCO_CATEGORIES
